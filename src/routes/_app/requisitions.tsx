...
import { listInventoryItems, deleteItem as deleteInventoryItemServer } from "@/lib/data.functions";
...
function Requisitions() {
  ...
  const { data: inventoryItems = [] } = useQuery({
    queryKey: ["items"],
    queryFn: async () => await listInventoryItems(),
  });
  ...
  async function deleteInventoryItem(id: string) {
    ...
    try {
      await deleteInventoryItemServer({ data: { id } });
