import { a4 as requireReact, W as jsxRuntimeExports, r as reactExports, R as getDefaultExportFromCjs, a5 as commonjsGlobal, a6 as React } from "./server-DkTiwXTO.js";
import { u as useQuery } from "./useQuery-CPGv4dSv.js";
import { e as listItems, b as listTransactions } from "./data.functions-BJW9FjRX.js";
import { c as createLucideIcon, a as cn, b as clsx, P as PageHeader, d as Package, e as ArrowLeftRight } from "./AppShell-a1FTjCXc.js";
import { r as reactDomExports, u as useAuth, L as Link } from "./router-CfAHfNkT.js";
import { t as toDate, c as constructFrom, s as startOfDay, f as format$1 } from "./format-PJEwTTZm.js";
...
function StatusBadge({ quantity, reorder }) {
  let label = "Normal";
  let cls = "bg-success/15 text-success border-success/30";
  if (quantity === 0) {
    label = "Out of Stock";
    cls = "bg-destructive/15 text-destructive border-destructive/30";
  } else if (quantity <= Math.max(1, Math.floor(reorder / 2))) {
    label = "Critical";
    cls = "bg-destructive/15 text-destructive border-destructive/30";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-medium", cls), children: label });
}
...
var DefaultTooltipContent = (props) => {
  ...
  var renderContent2 = () => {
    if (payload && payload.length) {
      ...
      var items = sortedPayload.map((entry, i) => {
        ...
        var finalItemStyle = _objectSpread$x(_objectSpread$x({}, defaultDefaultTooltipContentProps.itemStyle), {}, {
  ...
  var finalStyle = _objectSpread$x(_objectSpread$x({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
  ...
  var positionStyle = props.hasPortalFromProps ? {} : _objectSpread$w(_objectSpread$w({
  ...
  var outerStyle = _objectSpread$w(_objectSpread$w({}, positionStyle), {}, {
...
function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
  ...
  var timingStyle = interKeys.reduce((res, key) => {
    ...
    return _objectSpread$s(_objectSpread$s({}, res), {}, {
...
var _excluded$a = ["option", "shapeType", "activeClassName", "inActiveClassName"];
...
var _excluded$8 = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType", "axisId"];
...
var _excluded$7 = ["x1", "y1", "x2", "y2", "key"], _excluded2$4 = ["offset"], _excluded3$3 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
var _excluded$5 = ["id"], _excluded2$3 = ["type", "layout", "connectNulls", "needClip", "shape"], _excluded3$2 = ["activeDot", "animateNewValues", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "hide", "isAnimationActive", "label", "legendType", "xAxisId", "yAxisId", "id"];
function _extends$5() {
...
function StaticCurve(_ref4) {
  ...
  var {
    ...
    needClip,
    shape
  } = props, others = _objectWithoutProperties$5(props, _excluded2$3);
...
function Dashboard() {
  ...
  const low = items.filter((i) => i.quantity > 0 && i.quantity <= i.reorder_level).length;
  const out = items.filter((i) => i.quantity === 0).length;
  const txMonth = txs.filter((t) => new Date(t.created_at) >= subDays(/* @__PURE__ */ new Date(), 30)).length;
  const days = Array.from({
    length: 30
  }, (_, i) => startOfDay(subDays(/* @__PURE__ */ new Date(), 29 - i)));
  const series = days.map((d) => {
    const key = format$1(d, "MMM d");
    const total2 = txs.filter((t) => t.type === "OUT" && format$1(startOfDay(new Date(t.created_at)), "MMM d") === key).reduce((s2, t) => s2 + t.quantity, 0);
    return {
      day: key,
      used: total2
    };
  });
  const lowItems = items.filter((i) => i.quantity <= i.reorder_level).slice(0, 8);
  const recentTx = txs.slice(0, 8);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Dashboard", subtitle: "Live overview of inventory operations" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-6 lg:p-8 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: Package, label: "Total Items", value: total, tone: "navy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: TriangleAlert, label: "Low Stock", value: low, tone: "warning" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: CircleX, label: "Out of Stock", value: out, tone: "destructive" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: ArrowLeftRight, label: "Transactions (30d)", value: txMonth, tone: "success" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 bg-card border border-border rounded-lg p-4 sm:p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg", children: "Monthly Usage" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Stock-out volume per day, last 30 days" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-muted-foreground" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 sm:h-56 lg:h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: series, margin: {
            top: 5,
            right: 10,
            left: -10,
            bottom: 0
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tick: {
              fontSize: 10
            }, stroke: "var(--color-muted-foreground)", interval: 4 }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "used", stroke: "var(--color-primary)", strokeWidth: 2, dot: false })
          ] }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-4 sm:p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg mb-3", children: "Quick Actions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/inventory", className: "block rounded-md border border-border px-3 py-2 text-sm hover:bg-accent", children: "+ Add new item" }),
            canWrite && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/stock", className: "block rounded-md border border-border px-3 py-2 text-sm hover:bg-accent", children: "Record stock movement" }),
            canWrite && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/suppliers", className: "block rounded-md border border-border px-3 py-2 text-sm hover:bg-accent", children: "Manage suppliers" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/assistant", className: "block rounded-md border border-border px-3 py-2 text-sm hover:bg-accent", children: "Ask the AI assistant" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 sm:p-5 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg", children: "Low Stock Alerts" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
            lowItems.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 text-sm text-muted-foreground", children: "All items at healthy stock levels." }),
            lowItems.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 sm:p-4 flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: i.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { quantity: i.quantity, reorder: i.reorder_level })
            ] }, i.id))
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 sm:p-5 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg", children: "Recent Transactions" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
            recentTx.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 text-sm text-muted-foreground", children: "No transactions recorded yet." }),
            recentTx.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 sm:p-4 flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: t.item?.name ?? "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
                  t.staff_name ?? "—",
                  " · ",
                  format$1(new Date(t.created_at), "MMM d, HH:mm")
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-semibold px-2 py-0.5 rounded-md border ${t.type === "IN" ? "bg-success/15 text-success border-success/30" : "bg-destructive/15 text-destructive border-destructive/30"}`, children: [
                t.type,
                " ",
                t.quantity
              ] })
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-5 flex items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-11 w-11 rounded-md grid place-items-center ${toneCls}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
